...
class Wrestlers extends React.Component {
    ...
    render() {
        let wrestlers = [].concat(this.state.wrestlers).sort(this.sortWrestlers);
    ...
    class BlogCard extends React.Component {
      ...
      render() {
        return (
          ...
          <div class="group perspective h-[386px] w-[200px]">
      ...
      render() {
        ...
        return (
          <div className="relative">
            <img class="h-96 w-full rounded-xl" src={img_src}></img>
